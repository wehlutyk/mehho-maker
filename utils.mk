utils-pkg.i :
	$(apt_install) acpid autojump build-essential byobu bzr checkinstall colordiff curl dcfldd debconf-utils debian-goodies deborphan dnsutils dstat etckeeper ethtool expect finger git htop ifstat iftop imagemagick iotop ipcalc iperf lsb-release lvm2 lynx mcrypt molly-guard mtr-tiny mutt nmap parted psmisc pwauth pwgen python-jinja2 python-pip python-virtualenv python-yaml rsync rtorrent subversion sysstat tcpdump tree unrar-free unzip vim virtualenvwrapper zsh
	touch $@
